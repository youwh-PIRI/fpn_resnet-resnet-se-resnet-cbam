...
model_urls = {
    ...
    'resnet50': 'https://www.dropbox.com/s/bt6zty02h9ibufi/RESNET50_CBAM_new_name_wrap.pth',
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_model = model_zoo.load_url(model_urls['resnet50'],map_location='cpu')
